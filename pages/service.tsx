            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
              ...
              <div className='w-full h-full flex items-center justify-center md:pr-24'>
                <div className='text-white text-sm md:text-lg font-medium'>
                  ...
                  <div className='my-1'>- Node/Express, Python/Django/Flask, PHP/Laravel, Go</div>
                  <div className='my-1'>- Machine learning, Artificial Intelligence</div>
                  ...
                  <div className='mt-4 text-base md:text-22'>Hourly Rate: <b className='text-green-400 font-semibold'>$25~50</b> depending on difficulty</div>
                </div>
              </div>
            </div>
          </div>

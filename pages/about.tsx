            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
              ...
              <div className='w-full h-full flex items-center justify-center md:pr-20'>
                <div className='text-white text-12 md:text-lg font-medium '>
                  ...
                  My name is <span className='underline'>Hiroki Ito</span> and I&apos;m a Skilled Professional Developer.<br/>
                  I have been working in web and mobile development for 7+ years.<br/>
                  ...
                  &nbsp;&nbsp;- Web scraping, Machine learning, Artificial Intelligence<br/>

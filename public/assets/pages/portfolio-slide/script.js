class Slider {
  constructor() {
    ...
    this.clock = null;
    this.camera = null;
    this.images = ['./bg01.jpg', './bg02.jpg', './bg03.jpg', './bg01.jpg'];
  ...
  bindAll() {  ['render', 'nextSlide']. forEach(fn => this[fn] = this[fn].bind(this)); }
  ...
  loadTextures() {
    ...
    this.disp = loader.load('./rock-_disp.png', this.render);
